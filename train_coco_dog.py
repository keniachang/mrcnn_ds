...
class CocoConfig(Config):
    ...
    NUM_CLASSES = 1 + 1  # Background + catagory
    ...
    DEFAULT_LOGS_DIR = '../drive/My Drive/mrcnn_coco_A_weights/logs'
...
class CocoDataset(utils.Dataset):
    def load_coco(self, dataset_dir, subset, year=DEFAULT_DATASET_YEAR, class_ids=None,
        ...
        if subset == "minival" or subset == "valminusminival":
            subset = "val"
        image_dir = "../drive/My Drive/{}/{}{}".format(dataset_dir, subset, year)
...
if __name__ == '__main__':
    ...
    if args.command == "train":
        '''
            NOTE: class_ids=[18] makes the coco dataset only on the dog category
        '''
        dataset_train = CocoDataset()
        dataset_train.load_coco(args.dataset, "train", year=args.year, class_ids=[18], auto_download=args.download)
