...
import train_coco80_dog_only as train_coco
...
if __name__ == '__main__':
    ...
    dataset = CocoValDog()
    dataset.load_coco(dataset_folder, dataset_type, year=year)
    dataset.prepare()
    ...
    output_path = input('Enter the save path for output '
                        '(e.g., ../drive/My Drive/mrcnn_coco80_A_weights/dog150_last5_acc.csv): ')
