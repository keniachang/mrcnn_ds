...
class CocoConfig(Config):
    ...
    DEFAULT_LOGS_DIR = '../drive/My Drive/mrcnn_coco80_C_weights/logs'
...
class CocoDataset(utils.Dataset):
    def load_coco(self, dataset_dir, subset, year=DEFAULT_DATASET_YEAR, class_ids=None,
                  selected_cat=None, return_coco=False, auto_download=False):
        ...
        # To train and infer on only selected category of COCO data

        # if not selected_cat:
        #     selected_categories = ['car', 'dog', 'cake']
        # else:
        #     selected_categories = [selected_cat]

        selected_categories = ['car', 'dog', 'cake']    # [3, 18, 61]
        selected_class_ids = coco.getCatIds(catNms=selected_categories)
        image_ids = []
...
if __name__ == '__main__':
    ...
    # Train or evaluate
    if args.command == "train":
        # Training dataset (train on data of all categories)
